...
if (isset($_POST['tambah'])) {
    ...
    if (isset($_FILES['gambar']) && $_FILES['gambar']['error'] === UPLOAD_ERR_OK) {
        ...
        if (move_uploaded_file($fileTmpName, $upload)) {
            ...
            $result = mysqli_query($mysqli, "INSERT INTO tb_about (isi1, isi2, image)
                VALUES ('$isi1', '$isi2', '$uploaddb')");
                                ...
                                <form method="post" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" class="form-control" name="isi1" required></textarea>
                                        </div>

                                        <div class="form-group">
                                            <label for="isi2">Isi Kedua</label>
                                            <textarea type="text" class="form-control" name="isi2" required></textarea>
                                        </div>
