...
$result = mysqli_query($mysqli, "SELECT * FROM tb_kategori_artikel WHERE id=$id");
...
if (isset($_POST['update'])) {
    ...
    $result = mysqli_query($mysqli, "UPDATE tb_kategori_artikel SET kategori_artikel='$nama_kategori' WHERE id=$id");
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="kategori_artikel" type="text" class="form-control" value="<?= $row_kategori ?>" name="kategori_artikel" required <?php if ($row_kategori == 'admin') { ?> readonly <?php } ?>>
                                        </div>
